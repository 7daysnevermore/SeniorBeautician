...
/**
 * Created by NunePC on 12/2/2560.
 */
...
public class AddEvent extends AppCompatActivity implements View.OnClickListener {
    ...
    public void AddEventtoFirebase(){
        ...
        if(!input_title.equals(null)&&hour1!=0&&hour2!=0){
            ...
            PlannerValues.put("day", String.valueOf(dd));
            PlannerValues.put("month", String.valueOf(mm));
            PlannerValues.put("year", String.valueOf(yyyy));
            ...
            String datekey = dd+"-"+mm+"-"+yyyy;
            String startkey = hour1+":"+minute1;

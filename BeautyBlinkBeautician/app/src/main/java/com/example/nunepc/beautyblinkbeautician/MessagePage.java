...
import com.example.nunepc.beautyblinkbeautician.model.ChatStructure;
...
public class MessagePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("keyforchat");
        ...
        final FirebaseRecyclerAdapter<ChatStructure,MessagePage.chatViewholder>firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ChatStructure, MessagePage.chatViewholder>
                (ChatStructure.class,R.layout.chat,MessagePage.chatViewholder.class,ref){
            @Override

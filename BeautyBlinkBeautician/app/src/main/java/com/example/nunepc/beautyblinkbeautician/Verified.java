...
public class Verified extends AppCompatActivity {
    ...
    Toolbar toolbar;
    Button verifynow, uploadimg1, uploadimg2, uploadimg3, uploadimg4;
    ImageView citizenimg, certificate1, certificate2, certificate3;
    String pic;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (verified == null) {
                    ...
                    if (verified.citizenid != null) {
                        Picasso.with(Verified.this).load(verified.citizenid).fit().centerCrop().into(citizenimg);
                    }
                    if (verified.makeup != null) {
                        Picasso.with(Verified.this).load(verified.makeup).fit().centerCrop().into(certificate1);
                    }
                    if (verified.hairstyle != null) {
                        Picasso.with(Verified.this).load(verified.hairstyle).fit().centerCrop().into(certificate2);
                    }
                    if (verified.hairdressing != null) {
                        Picasso.with(Verified.this).load(verified.hairdressing).fit().centerCrop().into(certificate3);
                    }
                }
            }

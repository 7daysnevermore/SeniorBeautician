...
import com.example.nunepc.beautyblinkbeautician.model.ReviewViewHolder;
...
public class PreviewReviewFragment extends Fragment{
    ...
    private void initInstance(View rootView){
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("beautician-review"+"/"+mFirebaseUser.getUid());
